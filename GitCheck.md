...
|---|---|---|---|
| 2026-09-23 | phase-3-store-product-inventory | — (uncommitted) | Flutter app: full customer build (Riverpod 3 + go_router + Dio + secure storage, clean arch, all screens); analyzer 30 issues pending fix, not committed |
